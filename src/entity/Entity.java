...
public class Entity {
    ...
    public int spriteNum = 1; // walk animation
    int dialogueIndex = 0;
    public boolean collisionOn = false;
    public boolean invincible = false; // contact monster
    ...
    public void update() {
        ...
        if (this.type == type_monster && contactPlayer) { // monster attack player
            damagePlayer(attack);
        }
    ...
    public void draw(Graphics2D g2) {
        ...
        // check if the npc is display on the screen
    ...
    public void dyingAnimation(Graphics2D g2) { // Death Effect
